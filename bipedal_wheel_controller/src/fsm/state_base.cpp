...
{
void StateBase::updateEstimation(const Eigen::Matrix<double, STATE_DIM, 1>& x_left,
...
void StateBase::updateLegKinematics(double* left_angle, double* right_angle, double* left_pos, double* left_spd,
...
void StateBase::updateBaseState(const geometry_msgs::Vector3& angular_vel_base,
